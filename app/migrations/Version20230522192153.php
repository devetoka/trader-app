 ...
 */
final class Version20230522192153 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE api_token (id INT NOT NULL, owned_by_id INT NOT NULL, expires_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, token VARCHAR(255) NOT NULL, scopes JSON DEFAULT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE UNIQUE INDEX uniq_8d93d649e7927c09 ON api_token (token)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX uniq_8d93d649e7927c09');
